...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      products: {
        Row: {
          ...
          images: string[]
          liquidation_reason:
            | Database["public"]["Enums"]["liquidation_reason"]
            | null
          location: string
      ...
      report_actions: {
        Row: {
          action: Database["public"]["Enums"]["report_action_type"]
          admin_id: string
          admin_name: string
          created_at: string
          id: string
      ...
      seller_actions: {
        Row: {
          action: Database["public"]["Enums"]["seller_action_type"]
          admin_id: string
          admin_name: string
          created_at: string
          id: string
      ...
      subscribers: {
        Row: {
          ...
          frecuencia: string
          id: string
          metodo_contacto: Database["public"]["Enums"]["contact_method"]
          nombre: string
          zona: string
        }
        Insert: {
    ...
    Enums: {
      ...
      seller_action_type: "blocked" | "unblocked" | "verified" | "unverified"
