...
En todos los casos, la publicación fue aprobada por nuestro equipo de moderación.`,
  ...
  // Empezar a vender
  {
    ...
    answer: 'Andá a "Vender" en el menú y completá el formulario de registro con tus datos comerciales. Tu cuenta será revisada por nuestro equipo y te avisaremos por email cuando esté activa.',
    category: 'vendedor',
  ...
  },
  {
    ...
    answer: 'Solo productos nuevos (sin uso) con descuentos reales de mínimo 20% OFF. Pueden ser: liquidación de temporada, sobrestock, últimas unidades, packs o combos. No se aceptan productos usados, reacondicionados, falsificados, robados ni ilegales.',
    category: 'vendedor',
    tags: ['productos', 'vender', 'permitidos', 'liquidación', 'ofertas', 'nuevos', 'condición'],
  },
  {
    id: 'quien-puede-vender',
    question: '¿Quién puede vender en LiquiOff?',
    answer: 'Actualmente aceptamos tiendas, locales comerciales, marcas y emprendimientos que tengan productos nuevos para liquidar. Cada registro es revisado por nuestro equipo antes de ser aprobado. No aceptamos vendedores particulares u ocasionales por el momento.',
    category: 'vendedor',
    tags: ['vendedor', 'registro', 'requisitos', 'quién', 'tienda', 'marca'],
  },
  {
